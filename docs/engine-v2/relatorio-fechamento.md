...
Última atualização: 2026-07-23 — fase de evidência CONCLUÍDA; pendente apenas o consentimento de merge do autor
...
Além destes, mais 4 fixes de protocolo (§8-bis). O fix `4ba05f1` foi **validado em
produção**: às 14:00Z o worker detectou o limite, pausou anunciando o reset
(16:11Z) e retomou sozinho no segundo exato, sem queimar tentativa. Repetiu às
18:07Z → 21:11Z.
